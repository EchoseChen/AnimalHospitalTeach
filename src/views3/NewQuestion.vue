            ...
            <div class="col border-radius-lg">
                ...
                <div v-if="picked == 'select'">
                    ...
                    <div class="mt-2">
                        ...
                        <div>
                            <div v-for="item of question.options" :key="item.id" class="row mt-3 align-items-center ">
                        ...
                        <div v-if="!long" class="mt-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-3 mt-3">
                                    <argon-button @click="newAnswer" color="info" variant="gradient" class="col-12">+
                                        正确答案</argon-button>
                                </div>
                            </div>
                        </div>
    ...
    methods: {
        ...
        async postQuestion() {//POST
            ...
            if (this.showTest || result.ok) {
                this.$toast.success(`提交成功，问题ID: ${this.getQuestionId(result)}`, {
                    duration: 4000,
                    // position:"bottom"
                })
